--------------------------------------------------------
--  DDL for Procedure cargarAU_TEST_DESCRIPCION
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ALM_REPORT"."cargarAU_TEST_DESCRIPCION" AS
BEGIN
execute immediate 'TRUNCATE TABLE ALM_REPORT.AU_TEST_DESCRIPCION';
...
execute immediate  'insert into ALM_REPORT.AU_TEST_DESCRIPCION
SELECT
DISTINCT 
T.TS_TEST_ID,
T.TS_STATUS,
...
WHERE 
(
UPPER(T.TS_DESCRIPTION) NOT LIKE ''%OBJETIVO%'' AND
UPPER(T.TS_DESCRIPTION) NOT LIKE ''%ÉXITO%'' AND
UPPER(T.TS_DESCRIPTION) NOT LIKE ''%RECURSOS REQUERIDOS%'' AND
UPPER(T.TS_DESCRIPTION) NOT LIKE ''%PRECONDICIONES%''
)
';
