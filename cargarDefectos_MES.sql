--------------------------------------------------------
--  DDL for Procedure cargarDefectos_MES
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ALM_REPORT"."cargarDefectos_MES" AS
BEGIN

execute immediate 'TRUNCATE TABLE ALM_REPORT.DEFECTOS_MES';
...
execute immediate  'insert into ALM_REPORT.DEFECTOS_MES
SELECT
