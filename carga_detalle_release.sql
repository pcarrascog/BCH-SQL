--------------------------------------------------------
--  DDL for Procedure carga_detalle_release
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ALM_REPORT"."carga_detalle_release" AS
BEGIN
execute immediate 'TRUNCATE TABLE ALM_REPORT.DETALLE_RELEASE';
...
execute immediate  'insert into ALM_REPORT.DETALLE_RELEASE 
SELECT
DISTINCT
...
RC.RCYC_NAME, RC.RCYC_ID, R.REL_USER_04,
RC.RCYC_USER_03, 
to_date(RC.RCYC_USER_01,''yyyy/mm/dd'' ) , 
to_date(RC.RCYC_USER_02,''yyyy/mm/dd'' ), 
RC.RCYC_USER_01,
