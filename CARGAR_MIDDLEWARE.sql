--------------------------------------------------------
--  DDL for Procedure CARGAR_MIDDLEWARE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ALM_REPORT"."CARGAR_MIDDLEWARE" AS 
BEGIN
 execute immediate 'TRUNCATE TABLE ALM_REPORT.BCH_CONSOLIDADO';
...
execute immediate  'insert into ALM_REPORT.BCH_CONSOLIDADO 
...
INNER JOIN '||x.db_name||'.REQ RQ ON RQ.RQ_REQ_ID=RQR.RQRL_REQ_ID
      ...
      WHERE REL1.REL_ID IN (''1412'',''1548'',''1717'',''1750'', ''1805'',''1847'',''1870'')
      ...
      WHERE REL_ID IN (''1412'',''1548'',''1717'',''1750'', ''1805'',''1847'',''1870'')
      )tabla2 on tabla2.id_ciclo = RCYC.RCYC_ID

    
WHERE 1=1
AND REL.REL_ID IN (''1412'',''1548'',''1717'',''1750'', ''1805'',''1847'',''1870'')
...
execute immediate  'insert into ALM_REPORT.BCH_CONSOLIDADO 
select * from BCH_CONSOLIDADO@SERVER_BCH
';
